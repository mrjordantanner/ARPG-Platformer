...
namespace Assets.Scripts
{
    ...
    public static class SimplePool
    {
        ...
        public const int DEFAULT_POOL_SIZE = 300;
        ...
        public class Pool
        {
            ...
            // Constructor w/o Parent
            public Pool(GameObject prefab, int initialQty)//, GameObject parent)
            {
            ...
            public GameObject Spawn(Vector3 pos, Quaternion rot, GameObject parent)
            {
                GameObject obj;
        ...
        /// call that function.
        /// </summary>
        static public GameObject Spawn(GameObject prefab, Vector3 pos, Quaternion rot, GameObject parent)
        {
            Init(prefab);
