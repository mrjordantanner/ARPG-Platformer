...
namespace Assets.Scripts
{
    ...
    {
        [HideInInspector] public CharacterStatType type;
        ...
        public CharacterStat(CharacterStatType _type, float baseValue) : this()
        {
            type = _type;
            BaseValue = baseValue;
        }
    ...
    */
        ...
        public virtual void RemoveAllModifiersFromSource(StatModifierSource source)
        {
            foreach (var statMod in statModifiers)
