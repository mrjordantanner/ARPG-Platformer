...
namespace Assets.Scripts
{
    ...
    public class TransitionStartEditor : Editor
    {
        ...
        SerializedProperty m_UnloadCurrentSceneProp;
        ...
        void OnEnable ()
        {
            ...
            m_UnloadCurrentSceneProp = serializedObject.FindProperty("unloadCurrentScene");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            EditorGUILayout.PropertyField(m_UnloadCurrentSceneProp);
